    ...
    if (await requestStoragePermission()) {
      try {
        ...
        await Linking.openURL(
          'content://com.android.externalstorage.documents/document/primary%3ADownload%2Fdoodle',
        );
      } catch (e) {
        console.log(e);
      }
      ...
      <View className="flex-row items-center gap-1">
        ...
        <Switch
          ...
          onValueChange={async val => {
            MMMKV.setBool('useExternalPlayer', val);
...
{/* <TouchableNativeFeedback
      ...
      <View className="flex-row items-center justify-center gap-4 mt-12">
        <TouchableOpacity
          ...
          <AntDesign name="instagram" size={22} color="white" />
        </TouchableOpacity>
        <TouchableOpacity
          className="flex-row items-center justify-center "
